...
<body>
    ...
    <div class="container">
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
            ...
            <li><a href="./index.php" class="nav-link px-2 link-secondary"><i class="fas fa-home"></i> Home</a></li>
            <li><a href="./post.php" class="nav-link px-2 link-dark"><i class="fas fa-pen"></i> Post</a></li>
            </ul>
        ...
        <div class="col-md-7 col-lg-8">
            <form>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" name="img[]" type="file" accept="image/*" id="formFileMultiple" multiple>
                </div>
